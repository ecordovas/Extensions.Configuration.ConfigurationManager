...
namespace Microsoft.Extensions.Configuration.Test
{
    public class ConfigurationTest
    {
        ...
        public void SetValueThrowsExceptionNoSourceRegistered()
        {
            ...
            var resourceManager = new ResourceManager("Microsoft.Extensions.Configuration.Tests.Resources", typeof(ConfigurationTest).Assembly);
            var expectedMsg = resourceManager.GetString("Error_NoSources");
